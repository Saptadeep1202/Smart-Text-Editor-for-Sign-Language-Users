...
class Application:
    def __init__(self):
        ...
        self.hs = Hunspell('en_US')#, 'en_US.aff'
        self.vs = cv2.VideoCapture(0)
        self.current_image = None
        self.current_image2 = None
        
        #self.json_file = open(self.directory+"model-bw.json", "r")
        self.json_file = open("C:/Users/bhadr/Desktop/Trial/model/model-bw.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        #self.loaded_model.load_weights(self.directory+"model-bw.h5")
        self.loaded_model.load_weights("C:/Users/bhadr/Desktop/Trial/model/model-bw.h5")

        #self.json_file_dru = open(self.directory+"model-bw_dru.json" , "r")
        self.json_file_dru = open("C:/Users/bhadr/Desktop/Trial/model/model-bw_dru.json" , "r")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        #self.loaded_model_dru.load_weights("model-bw_dru.h5")
        self.loaded_model_dru.load_weights("C:/Users/bhadr/Desktop/Trial/model/model-bw_dru.h5")

        #self.json_file_tkdi = open(self.directory+"model-bw_tkdi.json" , "r")
        self.json_file_tkdi = open("C:/Users/bhadr/Desktop/Trial/model/model-bw_tkdi.json" , "r")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        #self.loaded_model_tkdi.load_weights(self.directory+"model-bw_tkdi.h5")
        self.loaded_model_tkdi.load_weights("C:/Users/bhadr/Desktop/Trial/model/model-bw_tkdi.h5")

        #self.json_file_smn = open(self.directory+"model-bw_smn.json" , "r")
        self.json_file_smn = open("C:/Users/bhadr/Desktop/Trial/model/model-bw_smn.json" , "r")
